...
class Pop:
    ...
    def get_record_pop(self):
        ...
        for full in range(1, 11):
            ...
            np.save(self.config['res_data']+'user_uninterest_item_front'+'_'+str(full)+'.npy',self.res)
...
if __name__ == '__main__':
    config = {
        '100k': {
            'split_gap': ',',
            'full':0.7,
            'train_data': '../../01数据集/100k/front_train_pop.csv',
        ...
        'ml1m': {
            ...
            'train_data': '../../01数据集/ml1m/front_train_pop.csv',
