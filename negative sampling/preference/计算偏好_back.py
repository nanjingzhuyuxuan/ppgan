...
class Pop:
    ...
    def get_record_pop(self):
        ...
        for index ,item in self.train.iterrows():
            ...
            data_interest[int(item['uid'])].pop(int(item['iid']))
        ...
        for full in range(1, 11):
            ...
            np.save(self.config['res_data']+'user_uninterest_item_'+'_'+str(self.config['full'])+'.npy',self.res)
...
if __name__ == '__main__':
    config = {
        '100k': {
            'split_gap': ',',
            'full':0.7,
            'train_data': '../../01数据集/100k/back_train_pop.csv',
        ...
        'ml1m': {
            ...
            'train_data': '../../01数据集/ml1m/back_train_pop.csv',
        ...
        'cd_movies': {
            ...
            'split_gap': ',',
            'train_data': '../../01数据集/cd_movies/back_train_pop.csv',
