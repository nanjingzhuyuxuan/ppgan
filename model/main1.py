...
if __name__ == '__main__':
    ...
    config = {
        '100k': {
            ...
            'uninterest': '../../../01数据集/100k/user_uninterest_item_weight_6.npy',
            'pop_tend': '../../../01数据集/100k/user_pop_tend_345600.npy',
        },

        'cd_movies': {
            'train': '../../../01数据集/cd_movies/all_train_pop.csv',
            'test': '../../../01数据集/cd_movies/test.csv',
            'uninterest': '../../../01数据集/cd_movies/user_uninterest_item_weight_2.npy',
            'pop_tend': '../../../01数据集/cd_movies/user_pop_tend_5184000.npy',
        },
